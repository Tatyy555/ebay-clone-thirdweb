  ...
  return (
    <div className="max-w-6xl mx-auto p-2">
      <nav className="flex justify-between">
        <div className="flex items-center space-x-2 text-sm">
          {address ? (
            ...
            <button onClick={connectWothMetamask} className="connectWalletBtn">
              Connect your wallet
            </button>
          )}
      ...
      <section className="flex items-center space-x-2 py-5">
        ...
        <Link href="/create">
          <button className="border-2 boreder-blue-600 px-5 md:px-10 py-2 text-blue-600 hover:text-blue-600/50 hover:text-white cursor-pointer">
            List Item
          </button>
        </Link>
      </section>
      ...
      <section className="flex py-3 space-x-6 text-xs md:text-sm whitespace-nowrap justify-center px-6">
            ...
            <p className="link">Electornics</p>
            <p className="link">Computers</p>
            <p className="link hidden sm:inline">Video Game</p>
